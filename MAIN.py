...
if __name__ == '__main__':
    ...
    gru_1 = GRU(rnn_size, return_sequences=True, name='gru1')(inner)# TODO
    gru_1b = GRU(rnn_size, return_sequences=True, go_backwards=True, name='gru1_b')(inner)# TODO
    gru1_merged = merge([gru_1, gru_1b], mode='sum')
    gru_2 = GRU(rnn_size, return_sequences=True, name='gru2')(gru1_merged)# TODO
    gru_2b = GRU(rnn_size, return_sequences=True, go_backwards=True, name='gru2_b')(gru1_merged)# TODO
